...
**Qualification:** Qlik Sense Business Analyst — 2025 Release  
**Platform:** Qlik Cloud Analytics (QCA)
...
> and the 2024 New Customers story — presented as if delivering to a real executive audience.
...
built as part of the Qlik Sense Business Analyst Qualification Exam (2025 Release).

**Nutra Green** is an eco-friendly chain of convenience stores undergoing a data analytics
migration to Qlik Cloud. This app was designed to replace their legacy reporting system
...
| File | Description |
|---|---|
| `Nutra_Green_Sales_BAStart.qvf` | Qlik application file — import directly into QCA |
| `2024_Customer_Analysis.pdf` | Exported story — 2024 New Customers Analysis (3 slides) |
| `Data_Model.png` | Full screenshot of the Qlik data model |
...
3. Select `Nutra_Green_Sales_BAStart.qvf`
